# Generated by Django 5.0.2 on 2025-03-18 14:11

import django.db.models.deletion
import simple_history.models
import zvmediaserver.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=zvmediaserver.models.user_directory_path, verbose_name='Файл')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('book', models.ForeignKey(blank=True, max_length=200, null=True, on_delete=django.db.models.deletion.CASCADE, to='zvmediaserver.book', verbose_name='Книга')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookpositions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('books', models.ManyToManyField(blank=True, db_index=True, max_length=200, null=True, related_name='readinglists', to='zvmediaserver.book', verbose_name='Книга')),
                ('books_ordering', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='zvmediaserver.bookorderinginreadinglist', verbose_name='Порядок чтения')),
        ...
        migrations.AddField(
            model_name='book',
            name='subcategory',
            field=models.ManyToManyField(related_name='book', to='zvmediaserver.booksubcategory', verbose_name='Подкатегория'),
        ),
        migrations.CreateModel(
            name='BookTag',
            fields=[
        ...
        migrations.AddField(
            model_name='book',
            name='tag',
            field=models.ManyToManyField(blank=True, related_name='book', to='zvmediaserver.booktag', verbose_name='Тэги'),
        ),
        migrations.CreateModel(
            name='HistoricalBook',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='zvmediaserver.bookcategory', verbose_name='Категория')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical book author',
                'verbose_name_plural': 'historical book authors',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical book category',
                'verbose_name_plural': 'historical book categorys',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('book', models.ForeignKey(blank=True, db_constraint=False, max_length=200, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='zvmediaserver.book', verbose_name='Книга')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'historical book ordering in reading list',
                'verbose_name_plural': 'historical book ordering in reading lists',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('books_ordering', models.ForeignKey(blank=True, db_constraint=False, max_length=200, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='zvmediaserver.bookorderinginreadinglist', verbose_name='Порядок чтения')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'historical book reading list',
                'verbose_name_plural': 'historical book reading lists',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            name='HistoricalBookSubcategory',
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=200, verbose_name='Подкатегория')),
                ('slug', models.SlugField(max_length=255, verbose_name='Слаг')),
            ...
            options={
                'verbose_name': 'historical book subcategory',
                'verbose_name_plural': 'historical book subcategorys',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical book tag',
                'verbose_name_plural': 'historical book tags',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.AddIndex(
            model_name='book',
            index=models.Index(fields=['-create_time'], name='zvmediaserv_create__89c9b1_idx'),
        ),
    ]

...
class AltTextManager {
  ...
  #save() {
    ...
    console.log(this.#currentEditor.altTextData)
    this.#finish();
  }
  #onClick(evt) {
    if (evt.detail === 0) {
...
const PDFViewerApplication = {
  ...
  url: "/books/getpdf/",
  baseUrl: "/books/getpdf/",
  _downloadUrl: "/books/getpdf/",
  ...
  bindEvents() {
    ...
    eventBus._on("savwfile", webViewerSaveFile);
  },
  bindWindowEvents() {
    const {
      eventBus,
...
}
{
  ...
  var webViewerSaveFile = function (evt) {
    const fileInput = PDFViewerApplication.appConfig.saveFile;
    fileInput.click();
  };
}
...
const defaultOptions = {
  ...
  workerSrc: {
    ...
    value: "/static/js/pdf.js/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
...
class SecondaryToolbar {
  ...
  constructor(options, eventBus) {
    ...
    buttons.push({
      element: options.saveFileButton,
      eventName: "savefile",
      close: true
    });
...
function getViewerConfiguration() {
  return {
    ...
    secondaryToolbar: {
      ...
      saveFileButton: document.getElementById("secondarySaveFile"),
